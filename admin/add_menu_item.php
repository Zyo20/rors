...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // If no errors, insert the menu item
    if (empty($errors)) {
        $stmt = $conn->prepare("INSERT INTO menu_items (name, description, price, category_id, is_available, image) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssdsss", $name, $description, $price, $category_id, $is_available, $image);
        ...
        if ($stmt->execute()) {
            ...
            $errors[] = "Error adding menu item: " . $conn->error;
        }
...
<head>
    ...
    <title>Add Menu Item - Restaurant Ordering and Reservation System</title>
...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow container mx-auto px-4 py-8">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold mt-2">Add New Menu Item</h1>
        </div>
